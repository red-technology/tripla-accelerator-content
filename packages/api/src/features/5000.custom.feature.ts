 ...
 */
export default defineFeature('custom', 'Custom Example Feature', 'mdi-cog', 'An Example feature that does nothing.', {
  global: false,
  getManageResponse: async (context, data): Promise<tm.ManageResponse> => {
    return { states: {}, data: {}, tabs: {} };
  },
